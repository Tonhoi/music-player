...
export const DiscIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox="0 0 512 512">
        <title>Disc</title>
...
export const MusicIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} wight={width} height={height} viewBox="0 0 512 512">
...
export const TopicIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox="0 0 512 512">
...
export const ThemeIcon = forwardRef(({ className, width = '2.2rem', height = '2.2rem' }, ref) => (
    <svg width={width} height={height} className={className} ref={ref} viewBox="0 0 20 20">
        <defs>
...
export const AddPlaylistIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox="0 0 512 512">
...
export const SettingIcon = forwardRef(({ className, width = '2.2rem', height = '2.2rem' }, ref) => (
    <svg
...
export const ArrowRedoIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox="0 0 512 512">
...
export const PauseMusicIcon = ({ className, width = '1.8rem', height = '1.8rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox="0 0 512 512">
        <title>Pause</title>
        <path
            fill="none"
...
export const VolumeHighIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox="0 0 512 512">
...
export const VolumeMediumicon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox="0 0 512 512">
...
export const VolumeLowIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width={width} height={height} viewBox="0 0 512 512">
...
export const VolumeMuteIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        width={width}
